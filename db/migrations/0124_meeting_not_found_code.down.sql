-- =====================================================================
-- 0124 down - the door goes back to answering 409 SLOT_UNAVAILABLE for
--            an appointment that is not yours
--
-- Restores 0123's HB021, which collides with the code book_appointment
-- raises for a refused slot. A family asking about somebody else's
-- consultation is told the slot is unavailable again - the wrong
-- sentence, and one that implies a slot exists.
-- =====================================================================
...
DELETE FROM hbh.schema_migrations WHERE version = '0124';
